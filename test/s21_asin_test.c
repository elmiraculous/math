...
START_TEST(s21_asin_test_1) {
  long double value = 0;
  ck_assert_ldouble_eq_tol(s21_asin(value), asinl(value), S21_EPS);
}
END_TEST
...
START_TEST(s21_asin_test_10) {
  ...
  ck_assert_ldouble_nan(s21_asin(value));
}
END_TEST
...
Suite *asin_suite() {
  ...
  tcase_add_test(tc_core, s21_asin_test_13);
  tcase_add_test(tc_core, s21_asin_test_14);
  tcase_add_test(tc_core, s21_asin_test_15);
